              ...
              {stats.map((stat, index) => (
                <View key={index} style={styles.statItem}>
                  <View style={styles.statIconContainer}>
                    <Ionicons name={stat.icon as any} size={16} color="#E1D4C2" />
                  </View>
        ...
        <View style={styles.quickActionsSection}>
          ...
          <View style={styles.quickActionsGrid}>
            <TouchableOpacity 
              ...
              onPress={() => Alert.alert('QR Scan', 'QR scanner would open here')}
            >
            ...
            <TouchableOpacity 
              style={styles.quickActionCard}
              onPress={() => navigation.navigate('BusTracking', { screen: 'live-tracking' })}
            >
              <View style={styles.quickActionIcon}>
                <Ionicons name="location" size={24} color="#6E473B" />
              </View>
