...
const LiveTrackingScreen: React.FC = () => {
  ...
  const handleNavigateToBusDetails = (bus: any) => {
    navigation.navigate('BusDetails', { buses: [bus] });
  };
        ...
        <View style={styles.mapContainer}>
          ...
          >
            ...
            <Text style={styles.mapPlaceholderText}>
              {userLocation ? 'Your location: Active' : 'Location: Waiting...'}
            </Text>
          ...
          <View style={styles.mapControls}>
            ...
            <TouchableOpacity style={styles.mapControlButton} onPress={getUserLocation}>
